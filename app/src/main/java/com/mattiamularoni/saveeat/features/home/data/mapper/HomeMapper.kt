...
object HomeMapper {
     ...
     */
    fun dtoToEntity(dto: HomeDashboardDto, userId: String): HomeDashboardEntity {
    ...
    fun dtoToDomain(dto: HomeDashboardDto): com.mattiamularoni.saveeat.features.home.domain.repository.HomeDashboard {
        return com.mattiamularoni.saveeat.features.home.domain.repository.HomeDashboard(
            userId = dto.userId,
            expiringItems = dto.expiringItems.map { item ->
            ...
            topLeaderboardUsers = dto.topLeaderboard.map { user ->
            ...
            suggestedRecipes = dto.suggestedRecipes.map { recipe ->
            ...
            userProfile = com.mattiamularoni.saveeat.features.home.domain.repository.UserProfile(
    ...
    fun domainToEntity(domain: com.mattiamularoni.saveeat.features.home.domain.repository.HomeDashboard): HomeDashboardEntity {
        val dto = HomeDashboardDto(
            userId = domain.userId,
            expiringItems = domain.expiringItems.map { item ->
            ...
            topLeaderboard = domain.topLeaderboardUsers.map { user ->
            ...
            suggestedRecipes = domain.suggestedRecipes.map { recipe ->
            ...
            userProfile = com.mattiamularoni.saveeat.features.home.data.remote.UserProfileDto(
