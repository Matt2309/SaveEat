 ...
 *
 * @property categoryKey chiave standard del tipo di prodotto, snake_case minuscolo (es. "pomodoro");
 *   usata per il lookup delle immagini in pantry_item_assets.
 * @property category una tra "FRIDGE" | "PANTRY" | "FREEZER"; mappa direttamente su
