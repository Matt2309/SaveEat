...
object FavoriteRecipeMapper {
     ...
     */
    fun dtosToEntities(dtos: List<FavoriteRecipeDto>): List<FavoriteRecipeEntity> {
     ...
     */
    fun entitiesToDomain(entities: List<FavoriteRecipeEntity>): List<FavoriteRecipe> {
     ...
     * @return lista di domain models
     */
    fun dtosToDomain(dtos: List<FavoriteRecipeDto>): List<FavoriteRecipe> {
